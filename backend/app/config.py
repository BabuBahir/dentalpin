...
class Settings(BaseSettings):
    ...
    # legacy static grant map. When True, require_permission resolves through
    # the DB-backed, clinic-aware tables (roles/role_permissions/permissions/
    # clinic_role_overrides, issue #46) populated by the seed_rbac seeder.
